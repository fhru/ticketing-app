                    ...
                    <table class="table text-white">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $tiket->status }}</td>
                                <td>
                                    <a href="/train-transactions/{{$tiket->id}}/edit" class="btn btn-warning mb-1"><i
                                            class="fas fa-edit fontawesome"></i></a>
                                    <a href="/train-transactions/{{$tiket->id}}/delete" class="btn btn-danger"
