        ...
        <div class="container">
            <div class="row form-detail">
                ...
                <div class="col d-flex justify-content-end">
                    <div class="wrapper">
                        <a href="/airplane-list" class="btn btn-light button">
            ...
            <form action="/airplane-list/{{$pesawat->id}}/update" method="POST">
                @csrf
                <div class="row form-detail">
                    <div class="col">
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="kelas" id="kelas" class="custom-select">
                                        <option value="{{$pesawat->kelas}}" selected>{{$pesawat->kelas}}</option>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select class="js-example-basic-single" name="awal" id="awal" style="width: 100%;">
                                        <option selected value="{{$pesawat->awal}}">{{$pesawat->awal}}</option>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select class="js-example-basic-single" name="akhir" id="akhir"
                                        style="width: 100%;">
                                        <option selected value="{{$pesawat->akhir}}">{{$pesawat->akhir}}</option>
                                        @foreach ($data_bandara as $bandara)
                                        <option value="{{$bandara->alias}}">{{$bandara->nama_daerah}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="harga" type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="Harga" value="{{$pesawat->harga}}">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="avatar" id="avatar" class="custom-select">
                                        <option selected value="{{$pesawat->avatar}}">{{$pesawat->avatar}}</option>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Kode Penerbangan</label>
                                    <input name="kode_pst" type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="Kode" value="{{$pesawat->kode_pst}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="custom-select">
                                        <option selected value="{{$pesawat->status}}">{{$pesawat->status}}</option>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="modal-footer">
                                    <a href="/airplane-list" class="btn btn-secondary" data-dismiss="modal">Close</a>
