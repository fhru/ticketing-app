                ...
                <div class="col-lg">
                    <div class="wrapper">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @foreach ($data_pesawat as $item)
                                <tr>
                                    <td>{{$item->id}}</td>
                                    <td>{{$item->nama}}</td>
                                    <td class="table-primary">{{$item->kode_pst}}</td>
                                    <td>{{$item->pergi}}</td>
                                    <td>{{$item->awal}}</td>
                                    <td>{{$item->akhir}}</td>
                                    ...
                                    <td>
                                        <a href="/airplane-list/{{$item->id}}/edit" class="btn-sm btn-warning"><i
                                                class="fas fa-edit"></i></a>
                                        <a href="/airplane-list/{{$item->id}}/delete" class="btn-sm btn-danger"
