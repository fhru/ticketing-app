...
<body>
    ...
    <main>
        <div class="container">
            <div class="row form-detail">
                <div class="col-lg-2">
                    <img src="{{asset('admin/assets/img/train.png')}}" alt="" class="gambar w-75">
                </div>
                <div class="col-lg d-flex justify-content-center flex-column">
                    <h2 class="font-weight-bold">Edit Ticket</h2>
                    {{-- <div class="wrap">
                ...
                <div class="col d-flex justify-content-end">
                    <div class="wrapper">
                        <a href="/train-list" class="btn btn-light button">
            ...
            <form action="/train-list/{{$kereta->id}}/update" method="POST">
                @csrf
                <div class="row form-detail">
                    <div class="col">
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama Kereta</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="Nama Kereta" name="nama"
                                        value="{{$kereta->nama}}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="kelas" id="kelas" class="custom-select">
                                        <option selected value="{{$kereta->kelas}}">{{$kereta->kelas}}</option>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="Tanggal Pergi" name="pergi"
                                        value="{{$kereta->pergi}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label for="awal">Dari</label><br>
                                    <select class="js-example-basic-single" name="awal" id="awal" style="width: 100%;">
                                        <option selected value="{{$kereta->awal}}">{{$kereta->awal}}</option>
                                        @foreach ($data_stasiun as $item)
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label for="akhir">Ke</label><br>
                                    <select class="js-example-basic-single" name="akhir" id="akhir"
                                        style="width: 100%;">
                                        <option selected value="{{$kereta->akhir}}">{{$kereta->akhir}}</option>
                                        @foreach ($data_stasiun as $item)
                                        <option value="{{$item->alias}}">{{$item->nama_daerah}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="harga" type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="Harga" value="{{$kereta->harga}}">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="avatar" id="avatar" class="custom-select">
                                        <option selected value="{{$kereta->avatar}}">{{$kereta->avatar}}</option>
                                        <option value="kai.png">KAI</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="kode_krt" type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="Kode" value="{{$kereta->kode_krt}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="custom-select">
                                        <option selected value="{{$kereta->status}}">{{$kereta->status}}</option>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="modal-footer">
                                    <a href="/train-list" class="btn btn-secondary" data-dismiss="modal">Close</a>
                    ...
                    <form action="/airplane-list/create" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-example-basic-single" name="awal" id="awal" style="width: 100%;">
                                ...
                                @foreach ($data_bandara as $bandara)
                                <option value="{{$bandara->alias}}">{{$bandara->nama_daerah}}</option>
    @endforeach
    </select>
    </div>
    ...
    <div class="form-group">
        <label for="akhir">Ke</label><br>
        <select class="js-example-basic-single" name="akhir" id="akhir" style="width: 100%;">
            <option selected disabled>Choose...</option>
            @foreach ($data_bandara as $bandara)
            <option value="{{$bandara->alias}}">{{$bandara->nama_daerah}}</option>
            @endforeach
