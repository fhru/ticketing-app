        ...
        <div class="container">
            <div class="row form-detail">
                ...
                <div class="col-lg d-flex justify-content-center flex-column">
                    <h2 class="font-weight-bold">Ticket List</h2>
                    {{-- <div class="wrap">
            ...
            <div class="form-detail">
                <div class="row">
                    <div class="col-lg-4">
                        <form action="/train-list" method="GET">
                ...
                <div class="col-lg">
                    <div class="wrapper">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @foreach ($data_kereta as $item)
                                <tr>
                                    <td>{{$item->id}}</td>
                                    <td>{{$item->nama}}</td>
                                    <td class="table-primary">{{$item->kode_krt}}</td>
                                    <td>{{$item->pergi}}</td>
                                    <td>{{$item->awal}}</td>
                                    <td>{{$item->akhir}}</td>
                                    ...
                                    <td>
                                        <a href="/train-list/{{$item->id}}/edit" class="btn-sm btn-warning"><i
                                                class="fas fa-edit"></i></a>
                                        <a href="/train-list/{{$item->id}}/delete" class="btn-sm btn-danger"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Input Data Tiket Kereta</h5>
                ...
                <div class="modal-body">
                    ...
                    <form action="/train-list/create" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama Kereta</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                                placeholder="Nama Kereta" name="nama">
                        </div>
                        <div class="form-group">
