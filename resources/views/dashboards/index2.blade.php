...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div class="row form-detail">
                <div class="col-lg card p-4" data-aos="zoom-in">
                    <div class="img-top d-flex justify-content-center align-items-center flex-column">
                        ...
                        <h4 class="font-weight-bold mt-4">Airplane</h4>
                    </div>
                    <hr>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <a href="/airplane-list" class="btn btn-block btn-light shadow py-4"><i
                                        class="fas fa-ticket-alt mr-1 fa-2x"></i></a>
                            </div>
                            <div class="col">
                                <a href="/airplane-transactions" class="btn btn-block btn-light shadow py-4"><i
                                        class="fas fa-receipt mr-1 fa-2x"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg card p-4" data-aos="fade-down" data-aos-delay="300">
                    <div class="img-top d-flex justify-content-center align-items-center flex-column">
                        <img src="{{asset('admin/assets/img/train.png')}}" alt="" class="gambar">
                        <h4 class="font-weight-bold mt-4">Train</h4>
                    </div>
                    <hr>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <a href="/train-list" class="btn btn-block btn-light shadow py-4"><i
                                        class="fas fa-ticket-alt mr-1 fa-2x"></i></a>
                            </div>
                            <div class="col">
                                <a href="/train-transactions" class="btn btn-block btn-light shadow py-4"><i
                                        class="fas fa-receipt mr-1 fa-2x"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row form-detail">
                <div class="col-lg">
                    <a href="/user-list" class="btn btn-block btn-light shadow py-4"><i
