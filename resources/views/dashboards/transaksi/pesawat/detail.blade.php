                    ...
                    <div class="col-detail">
                        ...
                        <div class="row">
                            <div class="col-lg mt-2">
                                <small>Nama</small>
                                <h2 class="bold">{{$pesawat->nama}}</h2>
                                <small>{{$pesawat->email}}</small>
                            </div>
                            <div class="col-lg mt-2">
                                <small>Maskapai</small>
                                <h2 class="bold">{{$pesawat->nama_pesawat}}</h2>
                                <div class="destination mt-2">
                                    <span class="btn-sm button">{{$pesawat->from}}</span>
                                    <i class="fas fa-long-arrow-alt-right mx-3"></i>
                                    <span class="btn-sm button">{{$pesawat->to}}</span>
                                    <span class="badge badge-info ml-3">{{$pesawat->kode_pst}}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-lg mt-2">
                                ...
                                <h2 class="bold btn-lg text-center button kode">{{$pesawat->kode_tiket}}</h2>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-lg mt-2">
                                <small>Tanggal Pemberangkatan</small>
                                <h4 class="bold">{{$pesawat->pergi}}</h4>
                                <small>Pukul: <span class="bold">{{$pesawat->jam}}</span></small>
                            </div>
                            <div class="col-lg mt-2">
                                <small>Metode Pembayaran</small><br>
                                <img src="{{asset('admin/assets/img/'.$pesawat->pembayaran.'.svg')}}"
                                    class="pembayaran-img mt-2" alt="">
                            </div>
                            <div class="col-lg mt-2">
                                <small>Total Pembayaran</small>
                                <h2 class="bold text-info">IDR {{number_format($pesawat->total_harga,0,",",".")}}
                                </h2>
                            </div>
                            <div class="col-lg mt-2">
                                <small>Jumlah Penumpang</small>
                                <h4 class="bold">
                                    {{$pesawat->jml_penumpang}} Orang
                                </h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg d-flex justify-content-end">
                                <a href="/airplane-transactions" class="btn button">
