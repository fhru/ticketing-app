        ...
        <div class="container">
            ...
            <div class="row form-detail">
                    ...
                    <div class="card">
                        <div class="wrapper">
                            <div class="card-header">
                                <h5 class="card-title font-weight-bold">{{$item->nama_pesawat}}</h5>
                            ...
                            <div class="card-footer middle">
                                ...
                                @csrf --}}
                                <a href="/airplane-transactions/{{$item->id}}/detail" class="btn btn-sm btn-warning">
                                    Detail
                                </a>
                                @if ($item->status == 'Menunggu Pembayaran')
                                <a href="/airplane/payed/{{$item->id}}" class="btn btn-sm btn-success">
                                    Telah Dibayar
                                </a>
                                @endif
                                {{-- </form> --}}
                                <div class="row">
                                    <div class="col">
                                        <a href="/airplane-transactions/{{$item->id}}/edit"
                                            class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
                                        <a href="/airplane-transactions/{{$item->id}}/delete"
                ...
                <div class="col-lg text-center">
                    ...
                    <a href="/airplane-transactions" class="btn btn-sm btn-warning">Kembali</a>
                </div>
                @endif
            </div>
