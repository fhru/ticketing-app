        ...
        <div class="container">
            <div class="row form-detail">
                ...
                <div class="col d-flex justify-content-end">
                    <div class="wrapper">
                        <a href="/train-transactions" class="btn btn-light button">
            ...
            <div class="row form-detail">
                <div class="col">
                    <form action="/train-transactions/{{$data_tiket->id}}/update" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="Nama Kereta" name="nama_kereta"
                                        value="{{$data_tiket->nama_kereta}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label for="kode_pst">Kode Kereta</label>
                                    <input type="text" class="form-control" id="kode_krt" name="kode_krt"
                                        value="{{$data_tiket->kode_krt}}">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
