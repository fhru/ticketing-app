                    ...
                    <div class="col-detail">
                        ...
                        <div class="row">
                            <div class="col-lg mt-2">
                                <small>Nama</small>
                                <h2 class="bold">{{$kereta->nama}}</h2>
                                <small>{{$kereta->email}}</small>
                            </div>
                            <div class="col-lg mt-2">
                                <small>Kereta</small>
                                <h2 class="bold">{{$kereta->nama_kereta}}</h2>
                                <div class="destination mt-2">
                                    <span class="btn-sm button">{{$kereta->from}}</span>
                                    <i class="fas fa-long-arrow-alt-right mx-3"></i>
                                    <span class="btn-sm button">{{$kereta->to}}</span>
                                    <span class="badge badge-info ml-3">{{$kereta->kode_pst}}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-lg mt-2">
                                ...
                                <h2 class="bold btn-lg text-center button kode">{{$kereta->kode_tiket}}</h2>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-lg mt-2">
                                <small>Tanggal Pemberangkatan</small>
                                <h4 class="bold">{{$kereta->pergi}}</h4>
                                <small>Pukul: <span class="bold">{{$kereta->jam}}</span></small>
                            </div>
                            <div class="col-lg mt-2">
                                <small>Metode Pembayaran</small><br>
                                <img src="{{asset('admin/assets/img/'.$kereta->pembayaran.'.svg')}}"
                                    class="pembayaran-img mt-2" alt="">
                            </div>
                            <div class="col-lg mt-2">
                                <small>Total Pembayaran</small>
                                <h2 class="bold text-info">IDR {{number_format($kereta->total_harga,0,",",".")}}
                                </h2>
                            </div>
                            <div class="col-lg mt-2">
                                <small>Jumlah Penumpang</small>
                                <h4 class="bold">
                                    {{$kereta->jml_penumpang}} Orang
                                </h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg d-flex justify-content-end">
                                <a href="/train-transactions" class="btn button">
