    ...
    <main>
        <div class="container">
            <div class="row form-detail">
                <div class="col-lg-3">
                    <img src="{{asset('admin/assets/img/cargo.png')}}" alt="">
                </div>
            ...
            <div class="row form-detail">
                    ...
                    <div class="card">
                        <div class="wrapper">
                            <div class="card-header">
                                ...
                                <small class="badge badge-info mt-3">{{$item->kode_pst}}</small>
                            </div>
                            ...
                            <div class="card-footer middle">
                                ...
                                @csrf --}}
                                <a href="/my-account/airplane/payment/{{$parameter}}" name="submit"
                                    class="btn btn-sm btn-warning">
                                    Detail
                                </a>
                                {{-- </form> --}}
                                <a href="/my-account/airplane/print/{{$parameter}}" class="btn btn-sm btn-primary"
                                    target="_blank">
                ...
                <div class="col-lg text-center">
                    ...
                    <a href="/airplane-search" class="btn btn-sm btn-warning">Cari Tiket!</a>
                </div>
                @endif
            </div>
        </div>
