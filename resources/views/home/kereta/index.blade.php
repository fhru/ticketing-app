...
<head>
    ...
    <!-- My Css -->
    <link rel="stylesheet" href="{{asset('admin/assets/css/train-ticket-list.css')}}" type="text/css">
...
<body>
    ...
    <section class="ticket-section">
            ...
            <div class="row ticket">
                ...
                <div class="col-lg-4 float-left">
                    <div class="card" data-aos="fade-up">
                        <img src="{{asset('admin/assets/img/'.$kereta->avatar)}}"
                            class="card-img-top img-fluid mx-auto kai" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">{{$kereta->nama}}</h5>
                            <p class="sub-title small">{{$kereta->kelas}}</p>
                            <div class="card-text">
                                ...
                                <div class="train-code">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <p class="bold">{{$kereta->awal}}</p>
                                        </div>
                                        <div class="col">
                                            <p class="mt-2 small">To</p>
                                            <p class="bold">{{$kereta->akhir}}</p>
                                        </div>
                                    </div>
                                </div>

                                <span class="bold">{{$kereta->pergi}}</span><br>
                                <small>{{$kereta->jam}}</small>

                                <div class="price-box mt-3">
                                    <div class="row">
                                        <div class="col-lg">
                                            <span class="price text-info">IDR
                                                {{number_format($kereta->harga,0,",",".")}}</span>
                                        </div>
                                        <div class="col-lg">
                                            @php
                                            $parameter = $kereta->id;
                                            ...
                                            @endphp
                                            <form action="/train-ticket/form/{{$parameter}}" method="POST">
                                                @csrf
                ...
                @endforeach
                @if (!$data_kereta->isEmpty())
                @else
                <div class="col-lg text-center">
                    <div class="alert alert-danger">
                        <h5 class="font-weight-bold">Mohon Maaf Perjalanan Yang Anda Cari Tidak Tersedia</h5>
                        <small>Tips: Ubah Pencarian dengan Tanggal Atau Tujuan yang Berbeda</small><br>
                    </div>
                    <a href="/train-search" class="btn btn-sm btn-warning">Kembali</a>
                </div>
                @endif
            </div>

            {{-- <div class="row ticket2">
                <div class="col">
                    <img src="{{asset('admin/assets/img/'.$kereta->avatar)}}" class="card-img-top img-fluid mx-auto
            kai"
            alt="...">
        </div>
        <div class="col">
        ...
        <div class="col">
            <span class="price">IDR {{$kereta->harga}}</span>
        </div>
        <div class="col">
            <button class="btn btn-warning btn-block">Choose</button>
        </div>
        </div> --}}
