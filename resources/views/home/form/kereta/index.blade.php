                ...
                <div class="col-lg-8">
                    <div class="form-field">
                        <div class="form-input">
                            ...
                            @endphp
                            <form action="/train-ticket/form/{{$parameter}}/payment" method="POST" class="form-prevent">
                                @csrf
                ...
                <div class="col-lg-4">
                    <div class="form-detail">
                        <div class="tiket-header">
                            ...
                            <h5 style="font-weight: 700">{{$kereta->nama}}</h5>
                        </div>
                        <div class="row">
                            <div class="col">
                                <img src="" alt=""><img src="{{asset('admin/assets/img/'.$kereta->avatar)}}"
                                    class="card-img-top img-fluid mx-auto kai" alt="...">
                            </div>

                            <div class="col">
                                <small>{{$kereta->awal}}</small>
                                <i class="fas fa-long-arrow-alt-right mx-2"></i>
                                <small>{{$kereta->akhir}}</small>
                                <div class="row">
                                    <div class="col">
                                        <span class="font-weight-bold">{{$kereta->kelas}}</span>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <span>{{$kereta->pergi}}</span><br>
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                <div class="harga bg-warning">
                                    <span>IDR {{number_format($kereta->harga,0,",",".")}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
