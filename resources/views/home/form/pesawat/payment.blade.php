        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <div class="mb-4">
                        <small class="text-center">Nama</small>
                        <h2 class="bold">{{$data_tiket->nama}}</h2>
                    </div>
                    <div class="mb-4">
                        <small>Kode Tiket</small>
                        <h2 class="bold">{{$data_tiket->kode_tiket}}</h2>
                    </div>
                    <div class="mb-4">
                        <small>Jumlah Yang Harus Dibayar</small>
                        <h2 class="bold">IDR {{$data_tiket->total_harga}}</h2>
                    </div> --}}
                    <div class="row">
                        ...
                        <div class="col-lg mt-2">
                            ...
                            <h2 class="bold">{{$dataTicket->nama_pesawat}}</h2>
                    ...
                    {{-- <div class="row mt-3">
                        <div class="col-lg">
                            <small>Email</small>
                            <h2 class="bold">{{$dataTicket->email}}</h2>
                </div>
            </div> --}}
            <div class="row mt-4">
                <div class="col-lg mt-2">
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg mt-2">
                    ...
                    <img src="{{asset('admin/assets/img/'.$dataTicket->pembayaran.'.svg')}}" class="pembayaran-img mt-2"
                        alt="">
                </div>
                <div class="col-lg mt-2">
                    <small>Total Pembayaran</small>
                    <h2 class="bold text-info">IDR {{number_format($dataTicket->total_harga,0,",",".")}}</h2>
                </div>
            </div>

            <div class="row mt-4">
                <div class="col-lg middle">
                    <a href="{{route('orderPesawat')}}" class="btn btn-warning">Bayar Sekarang!</a>
                </div>
            </div>
